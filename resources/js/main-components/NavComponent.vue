                ...
                <div class="container mx-auto px-4">
                    <div class="flex items-center justify-center">
                        ...
                        <div class="sm:hidden cursor-pointer w-full items-center py-4">
                                <span class="inline text-white">Navigation Menu</span>
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white inline float-right" @click="toggleMenu" viewBox="0 0 24 24">
                    ...
                    <div class="block sm:hidden border-t-2 py-2 transition-medium" v-if="menuOpen">
...
export default {
    data: () => {
        return {
            menuOpen: false,
            langUrl: window.siteUrl+"/setlocale/"+window.localeToggle,
