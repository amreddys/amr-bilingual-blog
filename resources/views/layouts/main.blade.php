...
<head>
    ...
    <script>
        ...
        window.facebookurl = '{{config("social.facebook")}}';
        window.twitterurl = '{{config("social.twitter")}}';
        window.instagramurl = '{{config("social.instagram")}}';
        window.youtubeurl = '{{config("social.youtube")}}';
        window.logourl = "{{url('/images/logo.png')}}"
        window.otherLanguage = "తెలుగు";
        @php
...
<body class="font-body">
                ...
                <div class="flex flex-wrap">
                    <div class="md:w-4/12 w-full flex-shrink-0 px-6">
                        ...
                        <div class="social-components w-full flex mt-5 fill-current text-center">
                            <a class="" target="_blank" onclick="window.location=window.facebookurl">
                            ...
                            <a class="" target="_blank" onclick="window.location=window.twitterurl">
                                <svg viewBox="0 0 24 24" class="h-8 w-8 inline mx-2" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M23.954 4.569a10 10 0 0 1-2.825.775 4.958 4.958 0 0 0 2.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 0 0-8.384 4.482C7.691 8.094 4.066 6.13 1.64 3.161a4.822 4.822 0 0 0-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 0 1-2.228-.616v.061a4.923 4.923 0 0 0 3.946 4.827 4.996 4.996 0 0 1-2.212.085 4.937 4.937 0 0 0 4.604 3.417 9.868 9.868 0 0 1-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 0 0 7.557 2.209c9.054 0 13.999-7.496 13.999-13.986 0-.209 0-.42-.015-.63a9.936 9.936 0 0 0 2.46-2.548l-.047-.02z"/>
                                </svg>
                            </a>
                            <a class="" target="_blank" onclick="window.location=window.instagramurl">
                                <svg viewBox="0 0 24 24" class="h-8 w-8 inline mx-2" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a class="" target="_blank" onclick="window.location=window.youtubeurl">
                                <svg viewBox="0 0 24 24" class="h-8 w-8 inline mx-2" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="md:w-4/12 w-full flex-shrink-0 px-6">
                        ...
                        <div class="content text-md text-gray-400">
                            <div class="h-64 w-full justify-center">
                            <div class="fb-page" data-href="{{config('social.facebook')}}" data-tabs="timeline" data-width="" data-height="257" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="{{config('social.facebook')}}" class="fb-xfbml-parse-ignore"><a href="{{config('social.facebook')}}">{{config('app.name')}}</a></blockquote></div>
                            </div>
                        </div>
                    </div>
                    <div class="md:w-4/12 w-full flex-shrink-0 px-6">
                        ...
                        <div class="content text-md text-gray-400">
                            <div class="h-64 w-full bg-blue-500 mt-5">
                                <a class="twitter-timeline" data-height="16rem" data-theme="light" href="{{config('social.twitter')}}?ref_src=twsrc%5Etfw">Tweets by {{config('app.name')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v4.0&appId=355888537910625"></script>
</body>
</html>
